...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="../css/totales.css">
</head>
<body class="container">
  ...
  <header class="main-header">
    <div class="background-overlay py-5">
      <h1 class="text-white text-center">Totales de sus ganancias y perdidas</h1>
      ...
      <div class="text-center">
        ...
        <h2>En totales le permitirá buscar y obtener los resultados de las ganancias y/o perdidas de sus registros</h2>
      </div>
      </div>
